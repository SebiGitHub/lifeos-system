                        ...
                        .clickable {
                            ...
                            scope.launch {
                                snackbar.showSnackbar(
                                    if (!realtimeTracking) "Tracking en tiempo real activado." else "Tracking en tiempo real desactivado."
                                )
                            }
                        }
                        .padding(16.dp),
                ...
                Row(
                    modifier = Modifier
                        ...
                        .clickable {
                            ...
                            scope.launch {
                                snackbar.showSnackbar(if (!darkMode) "Modo oscuro activado." else "Modo oscuro desactivado.")
                            }
                        }
                        .padding(16.dp),
                    verticalAlignment = Alignment.CenterVertically,
